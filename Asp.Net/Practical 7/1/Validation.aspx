<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Prac7_1.WebForm1" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox2" runat="server" TextMode="Password"></asp:TextBox>
            ...
            <asp:TextBox ID="TextBox3" runat="server" Height="22px" style="margin-left: 28px" TextMode="Password"></asp:TextBox>
