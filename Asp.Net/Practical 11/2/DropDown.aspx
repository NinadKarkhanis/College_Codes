<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Prac11_1.WebForm1" %>
        ...
        <div>
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource1">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Emp_Gen" SortExpression="Emp_Gen">
                        <EditItemTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("Emp_Gen") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
