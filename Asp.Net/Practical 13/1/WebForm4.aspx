<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="Prac13_1.WebForm4" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1>
            <asp:Label ID="Label1" runat="server" Text="Thank You For response"></asp:Label>
